...
namespace PlayModeTests
{
    namespace BallTests
    {
        public class JudgeTheBallInstructionsSceneTests
        {
            Button startButton;
        ...
        <ul>
            ...
            <li><b>Test description:</b> Tests that once the game start button
                has been clicked, the scene containing the Judge The Ball game is loaded.
            </li>
        </ul>
        ")]
            [UnityTest]
            public IEnumerator WHEN_JudgeTheBallInstructionSceneStartButtonPressed_THEN_MoveToJudgeTheBallScene()
            {
                startButton.onClick.Invoke();
                yield return null;
                Assert.AreEqual(SceneName.JUDGE_THE_BALL_SCENE, SceneManager.GetActiveScene().name);
            }
        ...
        <ul>
            ...
            <li><b>Test description:</b> Tests that instructions for the Judge The Ball
                game are provided in this scene.
            </li>
        </ul>
        ")]
            [UnityTest]
            public IEnumerator WHEN_JudgeTheBallInstructionSceneLoad_THEN_InstructionsDisplay()
            {
                yield return null;
